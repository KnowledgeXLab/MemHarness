...
#SBATCH --mem=500G 
#SBATCH --output=logs/mem_adaptor/alfworld/grpo_%j.out
#SBATCH --error=logs/mem_adaptor/alfworld/grpo_%j.err
...
EXPERIMENT_NAME="train_grpo-7B-cold_start_20260519_epoch1"
