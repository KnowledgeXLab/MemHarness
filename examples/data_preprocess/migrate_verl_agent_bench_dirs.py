...
New layout:      <data>/MemAdaptor/verl-agent/{alfworld,webshop}/text/{train,test}.parquet
...
def main() -> int:
    ...
    parser.add_argument(
        "--repo-root",
        default=os.environ.get("MEMADAPTOR_REPO_ROOT")
    ...
    mem_root = os.path.join(data_dir, "MemAdaptor", "verl-agent")
