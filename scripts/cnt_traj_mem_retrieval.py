...
def main() -> None:
    ...
    ap.add_argument("--path", default="data/exp_results/MemAdaptor/pre_exp/alfworld/gpt-4.1-nano-with_agentic_memory-retrieve_memory_text/train_traj/0.jsonl", type=str, help="jsonl 文件路径，或包含 jsonl 的目录")
    ap.add_argument(
        "--glob",
        dest="glob_pat",
        default="*.jsonl",
