...
async def startup_event():
    ...
    try:
        ...
        # 如果auto_import为1，尝试导入指定的文件或按实验名匹配
        if auto_import or p_file or t_file:
            ...
            if not p_file and not t_file and experiment_name:
                ...
                base_dir = Path("/mnt/petrelfs/wurong/workspace/Exp_RL/data/exp-rl/exp_result") / sanitized / "db_exports"
