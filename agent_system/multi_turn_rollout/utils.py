...
def filter_group_data(batch_list : List[Dict],
    ...
    """
    if last_try:
        return batch_list, episode_rewards, episode_lengths, success, traj_uid, tool_callings, memory_retrieval_counts, episode_gamefiles
    ...
    memory_retrieval_counts = memory_retrieval_counts[keep_indices]
    episode_gamefiles = episode_gamefiles[keep_indices]
