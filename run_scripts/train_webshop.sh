...
EXPERIMENT_NAME="MemHarness-Webshop-7B"
EXPERIMENTS_ROOT="data/MemHarness/exp_results"
...
LOG_FILE="${EXP_DIR}/train_webshop-$(date +%Y%m%d_%H%M%S).log"
...
ray job submit --runtime-env-json "${RAY_JOB_RUNTIME_ENV_JSON}" -- \
  python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='MemHarness_webshop' \
